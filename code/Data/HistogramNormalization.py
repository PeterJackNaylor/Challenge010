...
def get_reference_image(in_folder, filename=reference_image_name): 
    ...
    if len(reference_img_names) == 0:
        ...
        reference_img_names = ["../../../../../dataset/stage1_train/1b518cd2ea84a389c267662840f3d902d0129fab27696215db2488de6d4316c5/images/1b518cd2ea84a389c267662840f3d902d0129fab27696215db2488de6d4316c5.png"]
