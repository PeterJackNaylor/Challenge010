...
def CreateTFRecord(OUTNAME, PATH, FOLD_TEST, SIZE,
                   TRANSFORM_LIST, UNET, SEED, N_EPOCH,
                   SPLIT="train"):
...
def augment(image_f, annotation_f):
    ## the augmentation doesn't add anything on the borders
...
if __name__ == '__main__':
    ...
    BlurRGB, BlurLab = RandomBlur(RGB, LAB)
...
#    r_RGB, r_LAB = since
    b_RGB, b_LAB = sess.run([BlurRGB, BlurLab], feed_dict={RGB:img, LAB:lab})
